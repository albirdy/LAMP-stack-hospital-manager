...
<body>
	...
	<nav class="topnav" id="myTopnav">
		...
		<div class="dropdown">
			...
			<div class="dropdown-content">
			  ...
			  <a href="#" class="active">View by Specialties</a>
	...
	<h2>View Doctors by Specialty</h2>

    <form action="resultsviewbyspecialties.php" method="post" enctype="multipart/form-data">
			Select specialty: <br>
			<?php include '../lists/specialities.php'; ?>
			<br>
